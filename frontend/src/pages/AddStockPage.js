...
function AddStockPage() {
    ...
    // تم إبقاء أنواع الزي داخل المصفوفة لاستخدامها في القائمة المنسدلة أدناه وتجنب خطأ ESLint
    const uniformTypes = ['رسمي', 'رياضي', 'جاكيت'];
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <div className="d-grid mt-4">
                            <Button variant="primary" type="submit" disabled={loading}>
                                {loading ? <Spinner as="span" animation="border" size="sm" /> : 'إضافة للمخزون'}
                            </Button>
                        </div>
                    </Form>
                </Col>
